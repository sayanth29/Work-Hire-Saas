    ...
    <div className="h-[calc(100vh-140px)] flex gap-4">
      ...
      <div className="w-72 shrink-0 bg-white rounded-xl border border-[#c7c4d8] flex flex-col overflow-hidden">
        <div className="p-4 border-b border-[#c7c4d8]">
          <h2 className="font-semibold text-[#0b1c30]">Messages</h2>
          ...
          <>
            ...
            <div className="p-4 border-b border-[#c7c4d8] flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#777587]">{selected.companyName} · {selected.jobTitle}</p>
              </div>
            </div>
            ...
            <form onSubmit={sendMessage} className="p-4 border-t border-[#c7c4d8] flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 bg-[#f8f9ff] border border-[#c7c4d8] rounded-xl text-sm focus:outline-none focus:border-[#3525cd] focus:ring-1 focus:ring-[#3525cd] transition-all"
              />
              <button
                type="submit"
